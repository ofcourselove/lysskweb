                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td>
                                            <a href="<?php echo U('add', array('pid'=>$vo['id']));?>">添加子栏目</a>|<a href="<?php echo U('index', array('pid'=>$vo['id']));?>">查看下级栏目</a>|<a href="<?php echo U('edit', array('id'=>$vo['id']));?>">编辑</a> | <a href="<?php echo U('del', array('id'=>$vo['id']));?>" onclick="return ajaxBtn(this)">删除</a>
                                        </td>
