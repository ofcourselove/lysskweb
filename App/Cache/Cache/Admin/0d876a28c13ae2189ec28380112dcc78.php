                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td>
                                            <?php switch($vo["status"]): case "0": ?>待审核</caes>
                                                <case value="1">审核通过<?php break;?>
                                                <?php case "2": ?>审核驳回<?php break; endswitch;?>
                                        </td>
                                        <td>
                                            <a href="<?php echo U('Answer/index', array('problem_id'=>$vo['id']));?>">查看答案</a>|<a href="<?php echo U('status', array('id'=>$vo['id'], 'status'=>1));?>">审核通过</a>| <a href="<?php echo U('status', array('id'=>$vo['id'], 'status'=>2));?>">审核驳回</a>|<a href="<?php echo U('edit', array('id'=>$vo['id']));?>">编辑</a> | <a href="<?php echo U('del', array('id'=>$vo['id']));?>" onclick="return ajaxBtn(this)">删除</a>
                                        </td>
