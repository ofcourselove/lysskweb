                    ...
                    <div class="ibox-content">
                        ...
                        <?php else: ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="username" value="<?php echo ($vo["username"]); ?>"></input>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="nickname" value="<?php echo ($vo["nickname"]); ?>"></input>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">
